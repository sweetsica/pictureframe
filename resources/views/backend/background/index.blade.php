        ...
        <div class="main-content">
            ...
            <div class="prj-list row">
                ...
                <div class="col-lg-4 col-md-6 col-xs-12 margin-bottom-30">
                    <a href="{{route('background.edit',$background->id)}}" class="prj-item">
                        <div class="top-project-section">
                            <div class="project-icon">
                                <div class="custom-3">
                                    <img src="{{asset('gallery/background/'.$background->background_link)}}" alt="">
                                </div>
                            </div>
                            <h3>{{$background->background_name}}</h3>
                            <div class="meta">
                                <p class="author">
{{--                                    Price: {{$background->background_price}}--}}
                                </p>
                            </div>
                        </div>
