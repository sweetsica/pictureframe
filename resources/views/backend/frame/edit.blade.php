                        ...
                        <div class="card-content">
                            <form method="post" action="{{route('product.update',$product->id)}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name='product_name' type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter your product name" value="{{old('product_name',$product->product_name)}}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Product Price</label>
                                    <input name='product_price' type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter your price" value="{{old('product_price',$product->product_price)}}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputFile">File input</label>
                                    <input type="file" name='product_image' id="exampleInputFile" value="{{ old('product_image', $product->product_image) }}">
                                    <p class="help-block">Example block-level help text here.</p>
                                    <img src="{{asset('gallery/product/images/'.$product->product_image)}}" style="width:400px">
                                </div>
